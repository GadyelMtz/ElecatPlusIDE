...
// Generated from SimpleParser.g4 by ANTLR 4.13.1
 	import static Analizadores.SimpleSemantic.*; 	import java.util.HashMap; import static Analizadores.SimpleCode.*;
...
public class SimpleParser extends Parser {
	...
	public final SetupContext setup() throws RecognitionException {
		...
		try {
			...
			setState(86);
			match(RPAREN);
			new Quintupla(new CommonToken(-1,"setup"),((SetupContext) _localctx).ID,null,null);
			setState(88);
			bloque();
			}
		}
	...
	public final EjecucionContext ejecucion() throws RecognitionException {
		...
		try {
			...
			setState(92);
			match(RPAREN);
			new Quintupla(new CommonToken(-1,"loop"),((EjecucionContext)_localctx).O,null,null);
			setState(94);
			bloque();
			}
		}
